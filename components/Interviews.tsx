...
const Interviews: React.FC = () => {
  return (
    <section id="interviews" className="py-24 bg-[#080E1A]">
            ...
            <div key={interview.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
              <div className="w-full lg:w-3/5 relative group cursor-pointer">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 rounded-full border border-[#E8DCC4] flex items-center justify-center bg-[#0B1221]/40 backdrop-blur-sm group-hover:scale-110 transition-transform">
              ...
              <div className="w-full lg:w-2/5 space-y-4">
                ...
                <div className="pt-4">
                   <button className="px-8 py-3 border border-[#E8DCC4]/40 hover:border-[#E8DCC4] hover:bg-[#E8DCC4] hover:text-[#0B1221] transition-all duration-300 text-xs uppercase tracking-widest font-bold">
