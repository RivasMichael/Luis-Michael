...
const Publications: React.FC = () => {
  return (
    <section id="publications" className="py-24 bg-[#0B1221]">
          ...
          {PUBLICATIONS.map((pub) => (
            <div key={pub.id} className="bg-[#141C2D] p-4 flex flex-col group cursor-pointer hover:bg-[#1A253A] transition-colors duration-300 shadow-xl">
              <div className="relative mb-6 aspect-[3/4] overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-[#E8DCC4] text-[#0B1221] px-3 py-1 text-[10px] font-bold uppercase tracking-widest">
                  {pub.edition}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button className="bg-[#E8DCC4] w-10 h-10 flex items-center justify-center text-[#0B1221] hover:bg-white transition-colors">
